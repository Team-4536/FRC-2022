...
public class AutoBlueTarmac1 extends SequentialCommandGroup {
  /** Creates a new AutoPractice. */
  public AutoBlueTarmac1(CargoArm cargoArm, DriveTrain driveTrain, CargoHandler cargoHandler, Gyroscope gyroscope) {
